...
import { setSelected } from "../../../../redux/home";
    ...
    return (
      <div>
        <div className={styles.cardBox}>
          ...
          <div className={styles.card}>
            <div>
              <div className={styles.numbers}>{ventas}</div>
          ...
          <div className={styles.card}>
            <div>
              <div className={styles.numbers}>{categories}</div>
              <div className={styles.cardName}>Categorias</div>
            </div>
            <div className={styles.iconBx}>
          ...
          <div className={styles.card}>
            <div>
              <div className={styles.numbers}>S/{ingresos}</div>
